...
function drawDOM() {
    ...
    for (team of teams) {
        ...
        title.appendChild(createDeleteTeamButon(team));
...
function createMemberRow(team, table, member) {
    ...
    actions.appendChild(createDeleteTeamRowButon(team, member));
}

function createDeleteTeamRowButon(team, member) {
...
function createDeleteTeamButon(team) {
    let btn = document.createElement('button');
    btn.className = 'btn btn-primary';
